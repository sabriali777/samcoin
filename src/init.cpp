...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "\n" + _("SSL options: (see the Samcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Samcoin is probably already running."), strDataDir.c_str()));
